...
bucle que itere 10 veces (i < 10) si la iteración es par se deberá 
sumar a sumaPares el número de la iteración actual (i)*/
let sumaPares = 0;
...
/*17.- Crear variable booleanoMix1 cuyo valor sea la comparación 
booleana (booleano1 and (TAU/2 sea igual a PI)) or 
(variableValorNumerico mayor o igual que MiNumeroFav)*/
let booleanoMix1 = (booleano1 && (TAU / 2 === PI)) || (variableValorNumerico >= MiNumeroFav);

/*18.- Crear variable seisNoEsNueve cuyo valor sea la comparación 
booleana 6 no es estrictamente igual que 9*/
let seisNoEsNueve = 6 !== 9;

/*19.- Crear variable booleanoMix2 cuyo valor sea la comparación 
booleana variableValorNumerico positivo (0 no incluido) o menor que 
-(MiNumeroFav * TAU)*/
let booleanoMix2 = (variableValorNumerico > 0) || (variableValorNumerico < -(MiNumeroFav * TAU));


//Operadores
/*20.- Crear variable valorSuma cuyo valor sea la suma de MiNumeroFav 
y variableValorNumerico*/
let valorSuma = MiNumeroFav + variableValorNumerico ;

/*21.- Crear variable valorResta cuyo valor sea la resta de MiNumeroFav
y variableValorNumerico*/
